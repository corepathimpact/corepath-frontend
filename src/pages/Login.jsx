...
export default function Login() {
  ...
  const onSubmit = (e) => {
    ...
    // Demo auth only: platform access token. No tool selection/activation here.
      ...
      <div className="bg-gradient-to-r from-teal-900 to-teal-700 text-white py-20 px-6 text-center">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-teal-100 max-w-3xl mx-auto leading-relaxed">
            Sign in to access the platform, then activate the solutions you
            need.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        <div className="max-w-lg mx-auto rounded-2xl border border-gray-200 bg-white shadow-sm p-6">
          <p className="text-sm text-gray-700 leading-relaxed">
            This is a demo sign-in. Creating an account or logging in grants
            platform access only. Tool activation happens after login.
          </p>
